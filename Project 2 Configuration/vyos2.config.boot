...
nat {
    destination {
        rule 10 {
            description "Port Forward: HTTP to 10.0.6.10"
            destination {
                port 80
            }
        ...
        rule 30 {
            description "Port Forward: 8000 to 10.0.5.150"
            destination {
                port 8000
            }
    ...
    source {
        ...
        rule 20 {
            description "NAT from OPT to LAN"
